...
function init() {
	...
	$('#title').text(n01_data.gameOptions.title);
	
	$('#p1_name').text(n01_data.gameOptions.playerName[0] );
	$('#p2_name').text(n01_data.gameOptions.playerName[1] );

	$('#p1_sets').text(n01_data.gameOptions.winSets[0]);
	$('#p2_sets').text(n01_data.gameOptions.winSets[1]);
	...
	for (var i = 0; i < n01_data.gameOptions.setData.length; i++) {
		calcPlayer(stats1, 0, n01_data.gameOptions.setData[i]);
		calcPlayer(stats2, 1, n01_data.gameOptions.setData[i]);
	}
	if (n01_data.setData.endMatch !== 1) {
		calcPlayer(stats1, 0, n01_data.setData);
		calcPlayer(stats2, 1, n01_data.setData);
	}
